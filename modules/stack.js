/*
Data structure for querying minimums in stack. Using the C++ stack template:
...
class Stack {
  ...
  top() {
    if (this.stk.length == 0) {
      console.log('tried to get element from an empty Stack');
      return null;
    }
...
/*
This is just a copy of the above class, except with
this.cmp = (a, b) => (a < b);
this.equals = (a, b) => (a == b);
*/
class MinStack {
