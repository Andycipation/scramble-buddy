...
const actionsTroll = require("./modules/actions_troll");
const commands = require("./modules/commands");
const db = require("./modules/database");
const reactions_1 = require("./modules/reactions");
const solves = require("./modules/solves");
const timer = require("./modules/timer");
const bot = new Discord.Client();
bot.on('ready', () => __awaiter(void 0, void 0, void 0, function* () {
    bot.user.setActivity(`type '${config_1.default.prefix} help' for help`);
    yield actionsTroll.loadJokes();
    let dataChannel = (yield bot.channels.fetch(config_1.default.DATA_CHANNEL_ID));
...
bot.on('message', (message) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (userId == bot.user.id || (message.author.bot && config_1.default.IGNORE_BOTS)) {
        return;
    }
    if (message.channel.id == config_1.default.DATA_CHANNEL_ID) {
...
bot.on('messageReactionAdd', (messageReaction, user) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (user.id == bot.user.id || (user.bot && config_1.default.IGNORE_BOTS)) {
        return;
    }
    for (const raa of reactions_1.REACTION_ADD_ACTIONS) {
...
bot.on('messageReactionRemove', (messageReaction, user) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (messageReaction.emoji.name == reactions_1.REACTION_ADD_ACTIONS[0].emoji) {
        reactions_1.REACTION_ADD_ACTIONS[1].do(messageReaction, user);
    }
}));
